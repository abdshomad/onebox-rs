...
| ID | Task Description | Related SRS | Related Tests | Status | Priority |
|----|------------------|--------------|---------------|---------|----------|
| **T8** | **E2E Ping Tunnel**: Connect the client and server TUNs. Read a packet from the client TUN, send it to the server, and write it to the server TUN. Make `ping 8.8.8.8` succeed. | FR-C-02, FR-S-04 | TS1.1, TS1.2, TS1.3 | `In Progress` | High |
